...
// The active area is 124.8mm x 83.2mm, 96dpi
...
// LQ057Q: 115x86
// LQ058T: 128x70
// LQ064: 129x97, 640x480, case: 178.8x126.8x12.0 (LQ064V1DS11)

// ??? Sharp LM5H40TA (119x80) LQ057V3DG02 (115x86 + margin), similar (same?) pinout
// SHARP 5.5 inch display panel recommendation:
// LS055R1SX04 LS055R1SX03 LS055T1SX01 (122x69) LS055R3SX01 LQ055K3SX02 LQ055T3SX02
// LS055R1SC01 LQ055T3SX03 LQ055T3SX02Z  LS055T3SX05 LS055D1SX02 LS055R3SX01 (G)
// LM6Q32 LS055R1SX08 LS055T1SX01A LS055D1SX05(G) LM32C04P LM6Q40A
// LQ055W1GC01 LS055T1SX10 LQ055T3SX02Z(G) LS055D1SX04 LS055T3SX13 LS055T3SX09
// LQ055T3SX05 LS055T1SX13 LQ055W1GC01Z LM5H40TA LM5H40TB
// LQ055T1SX05 LQ055T3SX02(G) LS055T3SX01(G) LS055T1SX09
//
// GDN-D567AT-GTI056TN52 (112x84, 640x800)
//
// 6 inch e-ink: ED060SC7 (122x90, 600x800) EPD ($28, Kindle 3 D009001 spare part)
// 6 inch e-ink: GDE060BA-T, GDE060BAFL-T (front light, touch), (122x90, 600x800), 4:3,
...
/// ABCDEFGH -> HGFEDCBA
inline KUInt32
Swap_Pixels_FromBigEndian(const KUInt32 inWord)
{
	// ABCDEFGH -> GHEFCDAB
...
// -------------------------------------------------------------------------- //
void
TScreenManager::ChangeScreenSize(int inPortraitWidth, int inPortraitHeight)
{
	mPortraitWidth = inPortraitWidth;
	mPortraitHeight = inPortraitHeight;
		...
		switch (mScreenOrientation)
		{
			...
			case kOrientation_AppleBottom:
				Blit_90(
					...
					inMode);
				break;
				/* FIXME: Matt says: Blit_180 seems broken.
			case kOrientation_AppleLeft:
				Blit_180(
					baseAddy,
					srcRowBytes,
	...
	KUInt32 inMode)
{
	...
	KUInt32 indexRows;
	KUInt32 srcRowAddy = inBaseAddy
		+ (srcTop * inSrcRowBytes)
		+ (srcLeft * kBitsPerPixel / 8);
	KUInt8* dstPixelsRow = mScreenBuffer
	...
	KUInt32 inTimeInTicks /* = 0 */)
{
	...
	KUInt32 theSampleRecord = (theXCoord & 0x7FF) << 21
		| (theYCoord & 0x7FF) << 7
		| (inPressure & 0x0F);
...
TScreenManager::TransferState(TStream* inStream)
{
	...
	mTabletOrientation = (EOrientation) t;
	t = mScreenOrientation;
	inStream->TransferInt32BE(t);
	mScreenOrientation = (EOrientation) t;
