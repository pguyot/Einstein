...
/*
 ...
 Proteus
 	Classical Mythology: a sea god, son of Oceanus and Tethys, noted for his
 		ability to assume different forms and to prophesy.
 	a person or thing that readily changes appearance, character,
 		principles, etc.

 The code generated by the analyzer is supposed to run within the Einstein
 emulator as well as a stand-alone application
...
/**
 * Read the command line argumenta.
 */
