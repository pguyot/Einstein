...
#ifndef _AIF_FILE_READER_H
#define _AIF_FILE_READER_H

extern int readARMImageFile(const char *path);
extern int readREXFile(const char *path);

#endif /* _AIF_FILE_READER_H */
