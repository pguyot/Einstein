...
// /* 0x0C101044-0x0C101054 */
	...
	GLOBAL_GETSET_W_DECL(0x0C101054, ObjectId, CurrentTaskId);

	GLOBAL_GETSET_W_DECL(0x0C101058, ObjectId, gCurrentMonitorId);

	GLOBAL_GETSET_P_DECL(0x0C10105C, void*, CurrentGlobals);

// /* 0x0C101060-0x0C101A2C */

	GLOBAL_GETSET_W_DECL(0x0C101A2C, KUInt32, WantSchedulerToRun);

	GLOBAL_GETSET_W_DECL(0x0C101A30, KUInt32, SchedulerRunning);
