...
// License.
//
// The Original Code is TGPNodeIfThenElse.h.
//
...
// ***** END LICENSE BLOCK *****
// ===========
// $Id: TGPNodeIfThenElse.h,v 1.7 2004/11/23 15:11:31 paul Exp $
// ===========

#ifndef _TGPNODEIFTHENELSE_H
#define _TGPNODEIFTHENELSE_H
...
///
/// Classe pour un noeud Si/Alors/Sinon.
///
...
///
class TGPNodeIfThenElse
	:
		public TGPNode
{
public:
	///
	/// Constructeur par défaut à partir d'un type.
	///
	/// \param inType	type des branches alors et sinon.
	///
	TGPNodeIfThenElse( const TGPType& inType );
...
private:
	...
	/// \name Variables
	const TGPType&		mType;		///< Type des branches alors et sinon.
	TStringRef			mLispName;	///< Nom du noeud.
};

#endif
		// _TGPNODEIFTHENELSE_H
