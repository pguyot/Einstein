...
const char *TFLScriptEditor::code_types[] = {    // List of known C/C++ types...
    "nil",
    "true",
};
...
void TFLScriptEditor::style_parse(const char *text,
                                  char       *style,
                                  int        length)
{
    char         current;
...
void TFLScriptEditor::style_init()
{
...
void TFLScriptEditor::style_unfinished_cb(int, void*)
{
}
...
void TFLScriptEditor::style_update(int        pos,        // I - Position of update
